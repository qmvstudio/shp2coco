...
IMAGE_DIR = os.path.join(ROOT_DIR, "building_2021")
...
def from_mask_to_coco(root, MARK, IMAGE, ANNOTATION):
    ...
    if os.path.exists(ROOT_DIR):
        ...
        with open('{}/instances_building_{}2021.json'.format(ROOT_DIR, MARK), 'w') as output_json_file:
...
def main():
    ...
    from_mask_to_coco(ROOT_DIR, 'train', "building_2021", "annotations")
    from_mask_to_coco(ROOT_DIR, 'eval', "building_2021", "annotations")
    from_mask_to_coco(ROOT_DIR, 'test', "building_2021", "annotations")
